...
var PlatformForm = function (_Component) {
  ...
  function PlatformForm() {
    ...
    return _possibleConstructorReturn(this, (PlatformForm.__proto__ || Object.getPrototypeOf(PlatformForm)).apply(this, arguments));
  }
  ...
  _createClass(PlatformForm, [{
    ...
    key: 'renderNewPlatformButton',
    value: function renderNewPlatformButton() {
      return _react2.default.createElement(
    ...
    key: 'renderEditPlatformButton',
    value: function renderEditPlatformButton() {
      return _react2.default.createElement(
        _reactBootstrap.Well,
        { bsSize: 'large' },
        'Actions',
    ...
    key: 'renderViewPlatformButton',
    value: function renderViewPlatformButton() {
      return _react2.default.createElement(
        _reactBootstrap.Well,
        { bsSize: 'large' },
        'Actions',
    ...
    key: 'renderRemovePlatformButton',
    value: function renderRemovePlatformButton() {
      return _react2.default.createElement(
        _reactBootstrap.Well,
        { bsSize: 'large' },
        'Actions',
      ...
      return _react2.default.createElement(
        ...
        this.props.status.get('type') === 'SUCCESS' ? _react2.default.createElement(
          ...
          _react2.default.createElement(
            'h4',
            null,
            'Oh yeah! New Platform created succefully!'
          ),
          _react2.default.createElement(
            'p',
            null,
