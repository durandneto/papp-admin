...
function appReducer() {
	...
	switch (action.type) {
		...
		case _userGroup.SELECT:
			...
			// eslint-disable-next-line
			break;
		case _userGroup.UPDATE_SEARCH_TERM:
			return state.merge({ searchTerm: action.term });
			// eslint-disable-next-line
			break;
		case _userGroup.CREATED_NEW:
			...
			// eslint-disable-next-line
			break;
		case _userGroup.CREATED_NEW_ERROR:
			return state.merge({
				isSaving: false,
				status: {
					type: action.status,
		...
		case _userGroup.SEARCHED:
			...
			// eslint-disable-next-line
			break;
		case _userGroup.SEARCHED_COUNT:
			return state.mergeDeep({
				paginator: {
