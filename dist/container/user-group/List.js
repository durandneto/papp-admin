...
var UserGroups = function (_Component) {
	_inherits(UserGroups, _Component);

	function UserGroups() {
		_classCallCheck(this, UserGroups);

		return _possibleConstructorReturn(this, (UserGroups.__proto__ || Object.getPrototypeOf(UserGroups)).apply(this, arguments));
	}

	_createClass(UserGroups, [{
		key: 'componentWillMount',
		value: function componentWillMount() {
			if (!this.props.ListUserGroups.get('isLoadded')) this.props.fetch(this.props.ListUserGroups);
		}
	}, {
		key: '_search',
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(UserGroups);